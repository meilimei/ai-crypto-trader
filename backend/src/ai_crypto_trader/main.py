...
from ai_crypto_trader.api.admin.explanations import router as admin_explanations_router
...
def create_application() -> FastAPI:
    ...
    application.include_router(admin_explanations_router, prefix="/api")
